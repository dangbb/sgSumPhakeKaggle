...
class GraphSumModel(object):
    ...
    def encode(self, enc_input, cls_ids):
        print("[Step 2] - Inspect graphsum_model/encode")
        print("[Step 2] - Input:")
        print("[Step 2] - enc_input: ", enc_input)
        print("[Step 2] - cls_ids: ", cls_ids)
        ...
        print("[Step 7] - Value of output from roberta")
        print("[Step 7] - src_word input: ", src_word)
        print("[Step 7] - src_word_pos input: ", src_word_pos)
        print("[Step 7] - src_seg input: ", src_seg)
        print("[Step 7] - enc_words_output: ", enc_words_output)
