...
if __name__ == '__main__':
    ...
    parser.add_argument("-mode", default='format_to_paddle', type=str, help='format_to_json or format_to_paddle')
    parser.add_argument("-json_path", default='json_data/')
    parser.add_argument("-data_path", default='input_data')
    parser.add_argument("-vocab_path", default='./src/data_preprocess/config/vocab/spm9998_3.model')

    parser.add_argument("-roberta_vocab_file",
                        default='./src/data_preprocess/config/bpe/gpt2_bpe/vocab.txt',
                        type=str)
    parser.add_argument("-encoder_json_file",
                        default='./src/data_preprocess/config/bpe/gpt2_bpe/encoder.json',
                        type=str)
    parser.add_argument("-vocab_bpe_file",
                        default='./src/data_preprocess/config/bpe/gpt2_bpe/vocab.bpe',
                        type=str)

    parser.add_argument("-train_src", default='./src/data_preprocess/data/example.source')
    parser.add_argument("-train_tgt", default='./src/data_preprocess/data/example.target')
    parser.add_argument("-valid_src", default='./src/data_preprocess/data/example.source')
    parser.add_argument("-valid_tgt", default='./src/data_preprocess/data/example.target')
    parser.add_argument("-test_src", default='./src/data_preprocess/data/example.source')
    parser.add_argument("-test_tgt", default='./src/data_preprocess/data/example.target')
